...
let ChangePasswordDto = (() => {
    ...
    return class ChangePasswordDto {
        static {
            ...
            _currentPassword_decorators = [(0, swagger_1.ApiProperty)({ example: 'currentPassword123' }), (0, class_validator_1.IsString)()];
            _newPassword_decorators = [(0, swagger_1.ApiProperty)({ example: 'newPassword123' }), (0, class_validator_1.IsString)(), (0, class_validator_1.MinLength)(8)];
