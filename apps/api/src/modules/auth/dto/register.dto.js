...
let RegisterDto = (() => {
    ...
    return class RegisterDto {
        static {
            ...
            _username_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 'john_doe' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.Matches)(/^[a-zA-Z0-9_-]+$/, {
        ...
        username = (__runInitializers(this, _email_extraInitializers), __runInitializers(this, _username_initializers, void 0));
