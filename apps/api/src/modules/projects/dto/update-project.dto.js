...
let UpdateProjectDto = (() => {
    let _classSuper = (0, swagger_1.PartialType)((0, swagger_1.OmitType)(create_project_dto_1.CreateProjectDto, ['organizationId']));
    let _isActive_decorators;
    let _isActive_initializers = [];
    let _isActive_extraInitializers = [];
    return class UpdateProjectDto extends _classSuper {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _isActive_decorators = [(0, swagger_2.ApiPropertyOptional)({
