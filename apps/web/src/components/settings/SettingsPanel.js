...
function SettingsPanel() {
    ...
    const tabs = [
        { id: 'general', name: 'General', icon: outline_1.Cog6ToothIcon },
        { id: 'api', name: 'API Keys', icon: outline_1.KeyIcon },
        { id: 'models', name: 'Models', icon: outline_1.CircleStackIcon },
    ];
        ...
        <div className="p-6">
          {activeTab === 'general' && (<div className="space-y-6">
              ...
              <div>
                ...
                <input type="range" min="0" max="2" step="0.1" defaultValue="0.7" className="mt-1 block w-full"/>
              </div>
          ...
          {activeTab === 'api' && (<div className="space-y-6">
              <div>
                ...
                <input type="password" placeholder="sk-..." className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500"/>
              </div>
              ...
              <div>
                ...
                <input type="password" placeholder="sk-ant-..." className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500"/>
              </div>
            </div>)}
          ...
          {activeTab === 'models' && (<div className="space-y-6">
            ...
            ].map((model) => (<div key={model.name} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                    <div>
