      ...
      <div className="flex-1">
        ...
        <div className="rounded-lg bg-gray-100 px-4 py-3">
          <div className="typing-indicator">
            <div className="w-2 h-2 bg-gray-400 rounded-full animate-pulse" style={{ '--delay': 0 }}/>
            <div className="w-2 h-2 bg-gray-400 rounded-full animate-pulse" style={{ '--delay': 1 }}/>
            <div className="w-2 h-2 bg-gray-400 rounded-full animate-pulse" style={{ '--delay': 2 }}/>
          </div>
        </div>
      </div>
    </div>);
