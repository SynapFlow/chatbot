        ...
        <div className="ml-auto flex items-center gap-x-4 lg:gap-x-6">
          ...
          <div className="hidden sm:flex">
            <div className="relative">
              <input type="text" placeholder="Search..." className="block w-full rounded-md border-0 py-1.5 pl-3 pr-8 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6"/>
            </div>
          </div>
          ...
          <button type="button" className="-m-2.5 p-2.5 text-gray-400 hover:text-gray-500">
            ...
            <outline_1.BellIcon className="h-6 w-6" aria-hidden="true"/>
          </button>
