...
function AnalyticsDashboard() {
    const stats = [
        { name: 'Total Conversations', value: '1,234', icon: outline_1.ChatBubbleLeftRightIcon, change: '+12%' },
        { name: 'Documents Processed', value: '89', icon: outline_1.DocumentTextIcon, change: '+5%' },
        { name: 'Active Users', value: '45', icon: outline_1.UsersIcon, change: '+8%' },
        { name: 'Avg Response Time', value: '1.2s', icon: outline_1.ChartBarIcon, change: '-15%' },
    ];
    return (<div className="p-6">
      ...
      <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        ].map((item) => (<div key={item.topic} className="flex justify-between items-center">
